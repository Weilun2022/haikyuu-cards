...
DECKS: dict[str, dict[str, int]] = {
    ...
    # ── 疑似ユース（P03 ユース陣容，40 張）────────────────────────────────
    "YOUTH_P03": {
        "HV-P03-001": 2, "HV-P03-013": 2, "HV-P03-014": 2, "HV-P03-007": 2,
        "HV-P03-011": 2, "HV-P03-018": 5, "HV-P03-009": 3, "HV-P03-010": 4,
        "HV-P03-003": 2, "HV-P03-004": 1, "HV-P03-005": 3, "HV-P03-006": 2,
        "HV-P03-017": 2, "HV-P03-079": 3, "HV-P03-081": 5,
    },
    # ── 通用對手牌組（烏野風格，40 張均衡）──────────────────────────────────
    "STANDARD": {
        # 烏野系列牌（實際存在於資料庫的卡號）
