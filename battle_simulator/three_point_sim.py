...
PRESETS = {
 ...
 # ★★★★★ V6 均衡強化 (2026-06) ★★★★★
 # 核心調整 (vs V5): P02-017×4→×3; P02-085×3 新增(6種加速); P02-084×2→×1(保留ATK=8防守)
 #   P02-089 全0(反向削弱6種). 085棄1抽2讓6種 51%→83%, 084×1讓赤木D(7)+084(+2)=9≥ATK=8.
 # 效果(N=50000): 6種 83%, 穩定3分 72.3%, race-loss 0.7%, 平均第3分 10.9.
 "FINAL_V6": {
   "P02-087":3,"P02-088":3,"P02-085":2,"P02-084":1,
   "P02-024":2,"P02-034":3,"P02-027":3,"P02-020":2,
   "P02-077":3,"P02-035":2,"D03-011":2,"D03-005":2,
   "P02-032":2,"PR-048":3,"P02-017":3,"P02-018":2,"PR-049":2,
 },
