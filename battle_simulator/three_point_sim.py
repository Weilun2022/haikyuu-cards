...
PRESETS = {
 ...
 # ★★★★★ V6 均衡強化 (2026-06) ★★★★★
 # 規則修正: 事件上限8張 → 088×3→×2; 補銀島032×2→×3(角色).
 # vs V5: 017×4→×3; 085×2新增(6種加速); 084×2→×1(ATK=8門檻); 088×3→×2.
 #   事件: 087×3+088×2+085×2+084×1=8張.
 # 效果(N=50000): 6種 83.4%, 穩定3分 70.8%, race-loss 0.5%, 平均第3分 10.9.
 "FINAL_V6": {
   "P02-087":3,"P02-088":2,"P02-085":2,"P02-084":1,
   "P02-024":2,"P02-034":3,"P02-027":3,"P02-020":2,
   "P02-077":3,"P02-035":2,"D03-011":2,"D03-005":2,
