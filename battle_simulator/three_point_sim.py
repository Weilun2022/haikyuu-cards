...
PRESETS = {
 ...
 # ★★★★★ V6 均衡強化 (2026-06) ★★★★★
 # 規則修正: 事件上限8張. 088全砍(攔網封鎖效果對race-loss無貢獻); 085×4(6種最大加速).
 # 事件: 087×3+085×4+084×1=8張.
 # vs V5: 017×4→×3; 085×4新增(6種94%); 084×2→×1(ATK=8門檻); 088→0; 銀島032×2→×3.
 # 效果(N=50000): 6種 94.2%, 穩定3分 76.8%, race-loss 0.5%, 平均第3分 10.5.
 "FINAL_V6": {
   "P02-087":3,"P02-085":4,"P02-084":1,
   "P02-024":2,"P02-034":3,"P02-027":3,"P02-020":2,
   "P02-077":3,"P02-035":2,"D03-011":2,"D03-005":2,
 ...
 # ★★★★★★★ V8 最速三分 (2026-06, 不含 D03-001) ★★★★★★★
 # 目標: 最快打出第3分 (minimize avg3turn). 核心 = 087×4 引擎 + 021×4 速攻 finisher.
 # P02-021(宮治R, osamu_fin): 0 Guts, 出場後手牌≤2 → ATK+2, 「不需6種」→ 第3分不必等
 #   墓地6種, 在 どんぴ 打出第2分的同一回合即可接著收第3分, 比 V6 的6種 finisher 路線快~2回合。
 # 事件: 087×4(引擎MAX) + 085×4(填墓+抽牌續航) = 8張(上限).
 # 085 雖然主要價值在6種, 此處兼作抽牌引擎維持手牌流動 + 6種仍達94%(若021失手仍有backup空間).
 # 防禦: 034×2/032×2/049×2/011×2/035×2 接球body, race-loss壓到~1.75%.
 # 效果(N=30000×5seed): avg3turn T8.72, p3達成 89.4%, 穩定3分 85.6%, 6種 94%, race 1.75%.
 # vs V6(T10.5/穩3分76.6%): 快~1.8回合, 穩定3分+9%; 代價 race-loss 0.57%→1.75%(防禦較薄).
 "SPEED_V8": {
   "P02-087":4,"P02-085":4,
   "P02-021":4,"P02-077":4,"P02-020":4,"P02-018":3,"P02-016":2,"P02-024":3,
   "P02-034":2,"P02-032":2,"P02-035":2,"PR-049":2,"D03-011":2,"P02-033":1,"P02-025":1,
 },
 # V8b: 不需6種路線下, 032(銀島)/033(大耳, 第10名字燃料)/025(filter) 是6種時代遺留,
 #   無不可替代價值(033尤其RCV=3模型最弱)。砍此3卡4張, 全部灌注到「現有最強3條線」:
 #   034(赤木N, 0G RCV=6最硬接球body)2→4; 024(北信介, 3G撈どんぴ循環)3→4;
 #   018(香草侑, 舉球引擎本體)3→4。N=60000: 穩定3分 87.5%(原版85.6%, +1.9%),
 #   T8.5(原8.7更快), race-loss 1.5%(原1.7%更低), 純粹三維度同時變好的提升, 非trade-off。
 "SPEED_V8b": {
   "P02-087":4,"P02-085":4,
   "P02-021":4,"P02-077":4,"P02-020":4,"P02-018":4,"P02-016":2,"P02-024":4,
   "P02-034":4,"P02-035":2,"PR-049":2,"D03-011":2,
 },
...
if __name__ == "__main__":
    ...
    ap.add_argument("--preset", default="FINAL_V6")
