...
PRESETS = {
 ...
 # ★★★★★ V6 大見強化 (2026-06, 085×3 解鎖6種瓶頸) ★★★★★
 # 核心調整 (vs V5): 移除 P02-084×2(防禦過剩); P02-017×4→×3;
 #   換入 P02-085×3(大見太郎棄1抽2, 6種加速). P02-089 全0(反向削弱6種).
 # 效果(N=50000): 6種 51%→90.5%(+39.5%), 穩定3分 58%→77.4%(+19.3%).
 "FINAL_V6": {
   "P02-087":3,"P02-088":3,"P02-085":3,
   "P02-024":2,"P02-034":3,"P02-027":3,"P02-020":2,
   "P02-077":3,"P02-035":2,"D03-011":2,"D03-005":2,
